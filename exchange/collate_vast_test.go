...
func TestCollateVAST_SingleBidWithMetadata(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_SingleBidMissingAdvertiser(t *testing.T) {
	bids := []VastBidInput{
		{
	...
	assert.Contains(t, result.Errors[0].Error(), "missing required Advertiser or Pricing")
	assert.Equal(t, 1, me.missingMetadata["dsp-a"])
}

func TestCollateVAST_SingleBidMissingPricing(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_MultipleBidsSameVersion(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_VersionMismatch(t *testing.T) {
	bids := []VastBidInput{
		{
			BidID: "bid-1", ImpID: "imp-1", AdapterName: "seat-a",
			AdM: `<VAST version="3.0"><Ad><InLine>` +
...
func TestCollateVAST_NURLOnlyPassedViaMakeVAST(t *testing.T) {
	// NURL-only bids are wrapped by makeVAST at the call site, so CollateVAST
	// receives them as AdM. The generated wrapper lacks Advertiser/Pricing → discarded.
...
func TestCollateVAST_MalformedXML(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_EmptyAdM(t *testing.T) {
	bids := []VastBidInput{
...
func TestCollateVAST_AdWithNeitherInLineNorWrapper(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_MultipleAdsInOneBid_MixedMetadata(t *testing.T) {
	bids := []VastBidInput{
		{
			BidID: "bid-multi", ImpID: "imp-multi", AdapterName: "multi-seat",
			AdM: `<VAST version="3.0">` +
				`<Ad id="m1"><InLine><Advertiser>good.com</Advertiser><Pricing model="CPM" currency="USD">6.00</Pricing><Creatives></Creatives></InLine></Ad>` +
...
func TestCollateVAST_AllBidsDiscarded(t *testing.T) {
	bids := []VastBidInput{
		{
			BidID: "bid-1", ImpID: "imp-1", AdapterName: "seat-a",
...
func TestCollateVAST_EmptyInput(t *testing.T) {
	result := CollateVAST(nil, nilMetrics())
	assert.Empty(t, result.VastXML)
	assert.Nil(t, result.Errors)

	result2 := CollateVAST([]VastBidInput{}, nilMetrics())
...
func TestCollateVAST_MixOfGoodAndBad(t *testing.T) {
	bids := []VastBidInput{
		{
...
func TestCollateVAST_PriceFormattingPreserved(t *testing.T) {
	tests := []struct {
		price    string
		expected string
	}{
